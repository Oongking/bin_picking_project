...
rgb_image = cv2.imread(f'/home/oongking/RobotArm_ws/src/bin_picking/script/test/overlap_dataset/eraser_2/eraser_2_rgb_img.png')
pcd_model = o3d.io.read_point_cloud("/home/oongking/RobotArm_ws/src/model3d/script/buildModel/Data/eraser/erasser.pcd")
...
# o3d.io.write_point_cloud(f"/home/oongking/RobotArm_ws/src/bin_picking/script/test/overlap_dataset/eraser_2_sim.pcd", pcdcen)

icp = icp_pose_estimate(pcd_model,pcdcen,t_down= False)
tfm = icp.estimate()

draw_registration_result(pcd_model, pcdcen, tfm)
